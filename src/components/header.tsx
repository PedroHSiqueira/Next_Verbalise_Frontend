    ...
    <nav className="font-sans bg-gradient-to-r bg-[#693f94] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] fixed w-screen z-20 top-0">
      <div className="w-screen flex items-center justify-between px-2 lg:px-6 xl:px-10">
        ...
        <div className="lg:hidden flex items-end ">
          <button
            className="inline-flex items-center justify-center p-2 rounded-b-md text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
            onClick={abrirNavbar}
          >
            {isClicked ? (
              <svg
      ...
      {isClicked && usuario.id && (
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm-px-3">
            <Link
              href="/comunidades"
              className="flex justify-center flex-col font-bold py-2 px-3 text-white text-base rounded   md:p-0 "
            >
              Comunidades
            </Link>
            <Link
            ...
            <Link
              href="/perfil"
              className="flex justify-center flex-col font-bold py-2 px-3 text-white text-lg rounded "
            >
              Perfil
            </Link>
            <span
      ...
      {isClicked && !usuario.id && (
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm-px-3">
            <Link
              href="/informacoes"
              className="flex justify-center flex-col font-bold py-2 px-3 text-white text-base rounded "
            >
              Porque escolher nós
            </Link>
            <Link
