        ...
        {usuario.id ? (
          <div
            ...
            <ul className="flex items-center justify-center flex-row gap-36  font-medium ">
              <li>
                <Link href="#" className="flex items-center justify-center flex-col font-bold py-2 px-3 text-white text-lg rounded  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#B38000]  md:p-0 md:dark:hover:text-[#B38000]  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" >
              ...
              <li>
                <Link href="#" className="flex items-center mt-2 justify-center flex-col font-bold py-2 px-3 text-white text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#B38000]  md:p-0 md:dark:hover:text-[#B38000]  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
          ...
          <>
            <div className="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-sticky">
              <ul className="flex justify-around p-4 px-6 mt-0 gap-36 font-medium">
                <li>
                  <Link href="#" className="hidden py-2 px-3 text-white text-xs font-bold bg-blue-700 md:bg-transparent md:hover:text-[#B38000]  md:p-0 xl:block lg:text-sm xl:text-base"  aria-current="page">
                    Porque escolher nós
                  </Link>
                </li>
                <li>
                  <Link href="#" className="block py-2 px-3 text-white text-xs font-bold hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#B38000]  md:p-0 md:dark:hover:text-[#B38000]   lg:text-sm xl:text-base" >
            ...
            <div className="flex items-center justify-center md:order-2 space-x-3">
