          ...
          <div
            ...
            <ul className="flex items-center justify-center flex-row gap-36  font-medium ">
              <li>
                ...
                <img src="./navbar/comunidade.png" className='w-14 h-12' />
                  Comunidades
                </Link>
              </li>
              <li>
                ...
                <img src="./navbar/mensagens.png" className='w-14 h-12' />
                  Mensagens
                </a>
              </li>
              <li>
              ...
              <li>
                <span onClick={sairCliente} className="cursor-pointer transition delay-150 duration-300 ease-in-out flex items-center justify-center m-0 text-white bg-slate-800 hover:bg-[#B38000] focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-8 py-2 text-center ">
                  Sair
                </span>
              </li>
            </ul>
