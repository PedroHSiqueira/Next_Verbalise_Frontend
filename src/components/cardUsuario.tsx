  ...
  return (
    <Link href={`/detalhes/${data.id}`}>
        <div className="border rounded-lg max-w-[506px] max-h-[266px] p-4 shadow bg-[#f3efe5]">
          ...
          <p className="text-gray-600 text-sm mb-4">{data.descricao}</p>
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <span className="mr-2">Fala: </span>
              <img className="w-8 h-8" src="./Bandeiras/france.png" alt="França" />
            </div>
            <div className="flex items-center">
              <span className="mr-2">Aprende:</span>
              <img className="w-8 h-8" src="./Bandeiras/brazil.png" alt="Brasil" />
            </div>
          </div>
        </div>
    </Link>
