      ...
      <main className="mx-20">
        ...
        <section className="mb-14">
          <h2 className="flex items-center mb-2 gap-2 text-xl font-bold">
            Destaques <Trophy color={"#C4B454"} />
          </h2>
          <div className="flex flex-col gap-10 md:flex-row">
            <div className="w-fit mb-10">
              <h2 className="flex text-lg items-center justify-center gap-2 my-2">
                Email para contato <Mail size={17} />
              </h2>
              <h2 className="px-5 p-2 rounded-3xl border-2 border-[#b38000]">{usuarioSelecionado  .email as String}</h2>
            </div>
            <div>
              <h2 className="flex items-center text-lg justify-center gap-2 my-2">
                Usuário Desde <Clock size={17} />
              </h2>
