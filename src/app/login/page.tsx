    ...
    <div className="flex justify-center items-center flex-col gap-5 bg-[#0B0F18] w-screen h-screen">
      ...
      <form className="md:w-2/6" onSubmit={handleSubmit(verificaLogin)}>
        ...
        <div className="relative mb-6">
          ...
          <input type="email" className=" border text-sm rounded-lg block w-full ps-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" required {...register("email")} />
        </div>
        <label htmlFor="input-group-1" className="block mb-2 text-sm font-medium text-white">
          Sua Senha:
        </label>
        <div className="relative mb-6">
          ...
          <input type={visivel ? "text" : "password"} className=" border text-sm rounded-lg block w-full ps-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" required {...register("senha")} />
        ...
        <div className="flex items-start mb-5">
          <div className="flex items-center h-5">
            <Checkbox id="remember" className="w-4 h-4 border border-gray-300 rounded bg-gray-700 focus:ring-3 focus:ring-blue-300 " {...register("continuarConectado")} />
          </div>
          <label htmlFor="remember" className="ms-2 text-sm font-medium text-gray-300">
            Lembrar-se
          </label>
        </div>
        <button type="submit" className="text-white bg-[#B38000] font-bold hover:bg-[#947321] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm w-full px-5 py-2.5 text-center">
          Entrar
        </button>
