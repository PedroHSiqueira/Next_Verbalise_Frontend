    ...
    <div>
      ...
      <main className="mx-20">
        <section className="flex mb-14 flex-col md:flex-row lg:gap-10 lg:mb-10">
          <Image alt='avatar icon' width={215} height={215} src="https://files.tecnoblog.net/wp-content/uploads/2021/07/wagner-perfil.jpg" className='rounded-full max-w-60 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]' />
