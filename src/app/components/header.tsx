      ...
      <nav className="bg-gradient-to-r from-[#625173] via-[#625173] to-[#625173] fixed w-screen z-20 top-0">
        <div className="w-screen flex flex-wrap items-center justify-between px-10 p-4">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ">
            <Link href={"/login"} type="button" className="text-white bg-slate-800 hover:bg-[#B38000] focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-8 py-2 text-center ">Login</Link>
          </div>
